...
public class MyRectangle extends MyShape
{
    ...
    public MyRectangle(int _x1,int _y1,int _x2,int _y2, Color _color1, Color _color2, float _linew, boolean _filled, boolean _grad, boolean _dashed, int _dashl)
    {
    ...
    public void drawshape( Graphics g)
    {
        ...
        if(!filled)
            g2.draw( new Rectangle2D.Double(ox,oy,width,height) );
        else if(filled)
            g2.fill( new Rectangle2D.Double(ox,oy,width,height) );
    }
}
